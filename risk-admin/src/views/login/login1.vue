<template>
  ...
  <div class="login">
    <div class="login_content" v-if="isLogin">
      ...
      <div class="reg-bar">
          <a class="reg" href="javascript:void(0);" @click="goNavRegister">立即注册</a>
          <a class="forget" href="javascript:void(0);" target="_blank">忘记密码</a>
      </div>
    </div>
...
.login .reg-bar a { color: #fff; text-decoration: none; }
.login .reg-bar a:hover { text-decoration: underline; }
