<template>
  <div class="example">
    <div class="handleHead">
      <el-radio-group v-model="exampleType" size="small">
    ...
    <div class="example-container">
      ...
      <el-dialog
        title="习题详情"
        :visible.sync="exampleFlag"
        width="30%"
        :before-close="exapleDiaClose">
        <span class="exampleBox">
          <div class="exampleDetailHead">
            <p>标题标题标题标题标题标题标题标题标题标题标题标题标题标题【<span>单选</span>】</p>
            <dl>
              <dt>正确答案：D</dt>
              <dd>知识解析：</dd>
            </dl>
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="exampleFlag = false">取 消</el-button>
          <el-button type="primary" @click="exampleFlag = false">确 定</el-button>
        </span>
      </el-dialog>
    </div>
  </div>
